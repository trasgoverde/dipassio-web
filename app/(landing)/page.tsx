...
const LandingPage = () => {
  return (
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      Professional Solutions <span className='text-blue-600'> & Powerful Applications </span> Tailored to your Business needs
        </h1>
        <p className='mt-5 max-wprose text-zinc-700 sm:text-lg'>
          Dipassio is a digital product agency that focuses on strategy and design.
          </p>
          <Link 
       ...
       {/* Feature Section */ }
       <div className='mx-auto mb-32 mt-32 max-w5xl sm:mt-56'>
